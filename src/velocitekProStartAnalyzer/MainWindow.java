...
public class MainWindow {
	...
	private JLabel copyrightLabel = new JLabel(" Velocitek Prostart Analyser v.1.4 - Copyright (C) 2017 Maciej Jêdrzejko");	
		...
		btnAbout.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(
						frame, "Velocitek Prostart Analyser v.1.4 - Copyright (C) 2017 Maciej Jêdrzejko"
